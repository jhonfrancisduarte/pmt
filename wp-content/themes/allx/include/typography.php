<?php
	...
	/******************************
		* Font Sanitize
	******************************/
	function allx_array_fonts() {
		$array = array(
		'' => esc_attr__( 'inherit', 'allx' ),		
		'Helvetica' => esc_attr__( 'Helvetica', 'allx' ),
		'Arial' => esc_attr__( 'Arial', 'allx' ),
		'Oswald' => esc_attr__( 'Oswald', 'allx' ),
		'Verdana' => esc_attr__( 'Verdana', 'allx' ),
		'Tahoma' => esc_attr__( 'Tahoma', 'allx' ),
		'Trebuchet MS' => esc_attr__( 'Trebuchet MS', 'allx' ),
		'Impact' => esc_attr__( 'Impact', 'allx' ),
		'Times New Roman' => esc_attr__( 'Times New Roman', 'allx' ),
		'Courier' => esc_attr__( 'Courier', 'allx' ),
		);
		return $array;
	}
	function allx_sanitize_fonts( $input ) {
		$valid = allx_array_fonts();
	...
	/******************************
		* Font Wight Sanitize
	******************************/
	function allx_array_font_weight() {
		$array = array(
		'' => esc_attr__( 'Inherit', 'allx' ),		
		'100' => esc_attr__( 'Thin 100', 'allx' ),
		'200' => esc_attr__( 'Extra Light 200', 'allx' ),
		'300' => esc_attr__( 'Light 300', 'allx' ),
		'400' => esc_attr__( 'Normal 400', 'allx' ),
		'500' => esc_attr__( 'Medium 500', 'allx' ),
		'600' => esc_attr__( 'Semi Bold 600', 'allx' ),
		'700' => esc_attr__( 'Bold 700', 'allx' ),
		'800' => esc_attr__( 'Extra Bold 800', 'allx' ),
		'900' => esc_attr__( 'Ultra Bold 900', 'allx' ),
		);
		return $array;
	}
	function allx_sanitize_fonts_weight( $input ) {
		$valid = allx_array_font_weight();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	function allx_array_text_transform() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'allx' ),		
		'' => esc_attr__( 'None', 'allx' ),
		'capitalize' => esc_attr__( 'Capitalize', 'allx' ),
		'uppercase' => esc_attr__( 'Uppercase', 'allx' ),
		'lowercase' => esc_attr__( 'Lowercase', 'allx' ),
		);
		return $array;
	}
	function allx_sanitize_text_transform( $input ) {
		$valid = allx_array_text_transform();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function allx_array_font_style() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'allx' ),		
		'italic' => esc_attr__( 'Italic', 'allx' ),
		);
		return $array;
	}
	function allx_sanitize_font_style( $input ) {
		$valid = allx_array_font_style();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function allx_sanitize_float( $input ) {
		return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
	}
	
	add_action( 'customize_register', 'allx_typography_customize' );
	function allx_typography_customize( $wp_customize ) {
		
		$wp_customize->add_panel( 'seos_typography_panel' , array(
		'title'       => __( 'Typography', 'allx' ),
		'priority'    => 6,
		) );
		...
		******************************/		
		...
		'label'       => __( 'Font Size / px', 'allx' ),
		'description' => __( 'When the range is null, the default value is set.', 'allx' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		'max'  => 100,
		...
		******************************/		
		...
		'label'       => __( 'Mobile Font Size / px', 'allx' ),
		'description' => __( 'When the range is null, the default value is set.', 'allx' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		...
		******************************/
		...
		'sanitize_callback' => 'allx_sanitize_float',
		) );
		...
		******************************/		
		...
		'priority' => 9,
		'section' => 'typography_site_title',
		'label'       => __( 'Letter Spacing / px', 'allx' ),
		'description' => __( 'When the range is null, the default value is set.', 'allx' ),			
		'input_attrs' => array(
		'min'  => 0,
		'max'  => 10,
		...
		'panel'       => "seos_typography_panel",
		'title'       => __( 'Site Description', 'allx' ),
		'priority'    => 1,
		) );
		/******************************
			* Font
	...
	add_action( 'wp_enqueue_scripts', 'allx_typography_styles' );	
	function allx_typography_styles() {
