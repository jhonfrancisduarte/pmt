...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<input class="alpha-color-control" type="text" data-show-opacity="<?php echo $show_opacity; ?>" data-palette="<?php echo esc_attr( $palette ); ?>" data-default-color="<?php echo esc_attr( $this->settings['default']->default ); ?>" <?php esc_html( $this->link() ); ?>  />
